...
I navigate to job categories and click check box
    ...
    Sleep    1
    select checkbox    xpath=//*[@id="ohrmList_chkSelectRecord_14"]
    Sleep    2

I click more than one check box
    select checkbox    xpath=//*[@id="ohrmList_chkSelectRecord_13"]
    Sleep    2
    select checkbox    xpath=//*[@id="ohrmList_chkSelectRecord_17"]
    Sleep    2
